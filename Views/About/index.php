							...
							<div class="media">
								...
								<div class="media-body">
									...
									<ul class="tag clearfix">
										<li class="btn"><a href="#">Computer Hardware</a></li>
					...
					<div class="col-md-4 col-sm-6 col-md-offset-2">
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
							<div class="media">
								...
								<div class="media-body">
									<h4>Henry</h4>
									<h5>Founder and Sale Director</h5>
									<ul class="tag clearfix">
										<li class="btn"><a href="#">MBA</a></li>
										<li class="btn"><a href="#">Sofware Testing</a></li>
										<li class="btn"><a href="#">Consultance</a></li>
									</ul>
									<ul class="social_icons">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
					...
					<div class="col-md-4 col-sm-6 col-md-offset-2">
						<div class="single-profile-bottom wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms">
							<div class="media">
								...
								<div class="media-body">
									<h4>Tomas</h4>
									<h5>Founder and Technical Director</h5>
									<ul class="tag clearfix">
